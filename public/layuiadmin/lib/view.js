    ...
    i.loading = function (e) {
        ...
        return delete e.success, delete e.error, t.ajax(t.extend({
            type: "get", dataType: "json", success: function (t) {
                layer.close(zdyload);
                var n = o.statusCode;
                if (t[o.statusName] == n.ok) "function" == typeof e.done && e.done(t); else if (t[o.statusName] == n.logout) i.exit(function () {
                    var r = ["<cite>Error：未登录无法访问</cite> ", s()].join("");
                    i.error(r);
                    setTimeout(function () {
